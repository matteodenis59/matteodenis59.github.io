const translations = {
  fr: {
    ...
    projectEolienne: {
      ...
      methodMecaItem2b: `<strong>Axes des pales :</strong> montage en "O", avec bagues extérieures montées serrées dans les moyeux en PLA, verrouillées par des anneaux élastiques.`,
      ...
      methodManufItem1b: `<strong>Découpe Jet d'Eau :</strong> découpe de haute précision des disques de la base en aluminium.`,
      ...
      methodTestItem1a: `<strong>Validation des profils :</strong> les essais physiques ont confirmé les simulations CFD, la pale "16_4" surpassant les autres profils en maintenant un Cp plus élevé sur une large plage de fonctionnement.`,
      ...
      methodTestItem1c: `<strong>Performance finale :</strong> à la vitesse nominale, l'arbre délivre une puissance mécanique de 12,25 W, validant ainsi avec succès le cahier des charges initial imposant une puissance supérieure à 10 W.`,
  ...
  en: {
    ...
    projectEolienne: {
      ...
      methodMecaItem2b: `<strong>Blade shafts:</strong> mounted in an "O" arrangement, with outer races press-fitted into the PLA hubs and locked with retaining rings.`,
      ...
      methodManufItem1b: `<strong>Waterjet Cutting:</strong> high-precision cutting of the aluminium base discs.`,
      ...
      methodTestItem1a: `<strong>Profile validation:</strong> the physical tests confirmed the CFD simulations, with the "16_4" blade outperforming the other profiles by maintaining a higher Cp across a wide operating range.`,
      ...
      methodTestItem1c: `<strong>Final performance:</strong> at nominal speed, the shaft delivers 12.25 W of mechanical power, successfully validating the initial specification requiring more than 10 W.`,
