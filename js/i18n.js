const translations = {
  fr: {
    ...
    home: {
      ...
      tagline: "À la recherche d'un stage césure de 4 à 6 mois à partir de mars 2027 - Conception Mécanique · Aérodynamique & CFD · Amélioration Continue",
    ...
    projectEolienne: {
      ...
      captionProto: "Photo du prototype final.",
      methodTitle: "Démarche",
      ...
      methodAeroItem1a: `<strong>Choix cinématique :</strong> le modèle a démontré qu'une rotation des pales dans le sens inverse de l'axe central permettait de minimiser l'angle d'incidence et d'éviter un décrochage prématuré.`,
      methodAeroItem1b: `<strong>Dimensionnement global :</strong> l'algorithme a permis d'isoler les paramètres optimaux du rotor : un rayon R=140 mm, une demi-envergure de pale b=120 mm, un facteur a=0.072 et un λopt=0.486.`,
      ...
      methodAeroItem2a: `<strong>Maillage :</strong> étude de convergence en maillage validée à 1,7 million de cellules, avec un y+ rigoureusement contrôlé pour capturer la couche limite.`,
      methodAeroItem2b: `<strong>Résultats :</strong> le choix final s'est porté sur le profil "16_4" (épaisseur de 16 mm au centre s'affinant à 4 mm aux bords). Ce design offre un décrochage retardé à 11° et le meilleur rendement aérodynamique (Cp=0.31).`,
      ...
      methodMecaItem1a: `<strong>Tenue en flexion :</strong> simulation sous RdM Le Mans avec une force verticale de 60 N vers le bas (représentant le poids majoré d'un ensemble pale/axe de 600 g).`,
      methodMecaItem1b: `<strong>Efforts centrifuges :</strong> calcul analytique de la force radiale exercée par la pale en rotation nominale (F = mRΩ²/2 = 38,7 N) puis simulation sous RDM Le Mans`,
      methodMecaItem1c: `<strong>Validation matière :</strong> la contrainte maximale relevée est de 0,06 MPa (pour une limite élastique du PLA à 50 MPa), validant l'absence de déformation plastique (taux de déformation de 4.10⁻⁴ %).`,
      ...
      methodMecaText2: "La transmission du mouvement (rapport de réduction global de 1/2) est assurée par un train d'engrenages concourants imprimé en 3D (dents droites, roues de 10, 20 et 42 dents). La liaison encastrement sur les axes est réalisée par des vis de pression sur méplat avec inserts métalliques. Cette cinématique a été privilégiée aux courroies pour sa robustesse et l'absence de glissement.",
      methodMecaItem2a: `<strong>Axe principal :</strong> guidage par deux roulements à billes montés en "X" (entretoise centrale, écrou à encoches) avec un ajustement de précision H7/m6.`,
      methodMecaItem2b: `<strong>Axes des pales (moyeu tournant) :</strong> guidage par roulements rigides à billes. Les bagues extérieures sont montées serrées dans les moyeux en PLA. Les bagues intérieures sont montées glissantes sur l'axe fixe, l'ensemble étant bloqué par une entretoise et des anneaux élastiques.`,
      ...
      guidageAxe: "Vue en coupe du bâti montrant le montage en X pour l'axe principal.",
      ...
      methodManufItem1a: `<strong>Tournage et Fraisage :</strong> usinage des axes principaux et des stubs de pales en acier (chariotage, rainurage pour circlips, dressage) et réalisation des méplats pour assurer le blocage en rotation des engrenages.`,
      methodManufItem1b: `<strong>Découpe Jet d'Eau :</strong> découpe de haute précision des disques en acier du bâti.`,
      methodManufItem1c: `<strong>Impression 3D :</strong> fabrication des bras profilés et des engrenages coniques en PLA.`,
      ...
      methodTestItem1a: `<strong>Validation des profils :</strong> les essais en soufflerie (réalisés en amont de la phase de prototypage des pales) ont confirmé les simulations CFD, la pale "16_4" surpassant les autres profils en maintenant un Cp plus élevé sur une large plage de fonctionnement.`,
      methodTestItem1b: `<strong>Analyse des écarts :</strong> les pertes mécaniques (liées aux frottements des roulements et de l'engrènement) ont été modélisées et estimées entre 15 et 20 % de la puissance fluide captée.`,
      methodTestItem1c: `<strong>Performance finale :</strong> à la vitesse nominale, l'arbre délivre une puissance mécanique de 12,7 W, validant ainsi avec succès le cahier des charges initial imposant une puissance supérieure à 10 W.`,
      captionTest: "Test du prototype final en soufflerie.",
  ...
  en: {
    ...
    home: {
      ...
      title2: "Denis",
      title3: "École Centrale de Lille",
      tagline: "Seeking a second 4- to 6-month gap-year internship from March 2027 — Mechanical Design · Aerodynamics & CFD · Engineering & Performance",
    ...
    projectEolienne: {
      ...
      captionProto: "Final prototype picture.",
      methodTitle: "Approach",
      ...
      methodAeroItem1a: `<strong>Kinematic choice:</strong> the model showed that rotating the blades in the direction opposite to the central axis minimised the incidence angle and avoided premature stall.`,
      methodAeroItem1b: `<strong>Overall sizing:</strong> the algorithm made it possible to isolate the rotor's optimal parameters: a radius R=140 mm, a blade half-span b=120 mm, a factor a=0.072 and a λopt=0.486.`,
      ...
      methodAeroItem2a: `<strong>Mesh:</strong> a mesh convergence study was validated at 1.7 million cells, with y+ rigorously controlled to capture the boundary layer.`,
      methodAeroItem2b: `<strong>Results:</strong> the final choice was the "16_4" profile (16 mm thick at the centre, tapering to 4 mm at the edges). This design offers delayed stall at 11° and the best aerodynamic efficiency (Cp=0.31).`,
      ...
      methodMecaItem1a: `<strong>Bending strength:</strong> simulation under RDM Le Mans with a 60 N downward vertical force (representing the increased weight of a blade/shaft assembly of 600 g).`,
      methodMecaItem1b: `<strong>Centrifugal forces:</strong> analytical calculation of the radial force exerted by the blade at nominal rotation speed (F = mRΩ²/2 = 38.7 N), followed by simulation under RDM Le Mans`,
      methodMecaItem1c: `<strong>Material validation:</strong> the maximum stress recorded is 0.06 MPa (against a PLA yield strength of 50 MPa), confirming the absence of plastic deformation (strain rate of 4.10⁻⁴ %).`,
      ...
      methodMecaText2: "Motion transmission (global reduction ratio of 1/2) is provided by a 3D-printed straight bevel gear train (10, 20, and 42 teeth). The gears are secured to the shafts using set screws on flats with threaded inserts. This kinematic solution was chosen over belts for its robustness and lack of slippage.",
      methodMecaItem2a: `<strong>Main shaft:</strong> guided by two ball bearings mounted in an "X" arrangement (central spacer, slotted nut) with a precision H7/m6 fit.`,
      methodMecaItem2b: `<strong>Blade shafts (rotating hub):</strong> Guided by deep-groove ball bearings. Outer rings are press-fitted into the PLA hubs. Inner rings are slip-fitted onto the fixed shaft, with the entire assembly secured by a spacer and retaining rings.`,
      ...
      guidageAxe: "Cross-section view of the frame showing the X-mounting arrangement for the main shaft.",
      ...
      methodManufItem1a: `<strong>Turning and Milling:</strong> machining of the main shafts and blade stubs in steel (turning, groove-cutting for circlips, facing) and machining of flats to lock the gears against rotation.`,
      methodManufItem1b: `<strong>Waterjet Cutting:</strong> high-precision cutting of the frame's steel discs.`,
      methodManufItem1c: `<strong>3D Printing:</strong> manufacturing of the profiled arms and bevel gears in PLA.`,
      ...
      methodTestItem1a: `<strong>Profile validation:</strong> the wind tunnel tests confirmed the CFD simulations, with the "16_4" blade outperforming the other profiles by maintaining a higher Cp across a wide operating range.`,
      methodTestItem1b: `<strong>Gap analysis:</strong> mechanical losses (related to bearing and gear-meshing friction) were modelled and estimated at 15 to 20% of the captured fluid power.`,
      methodTestItem1c: `<strong>Final performance:</strong> at nominal speed, the shaft delivers 12.7 W of mechanical power, successfully validating the initial specification requiring more than 10 W.`,
      captionTest: "Testing the final prototype in the wind tunnel.",
